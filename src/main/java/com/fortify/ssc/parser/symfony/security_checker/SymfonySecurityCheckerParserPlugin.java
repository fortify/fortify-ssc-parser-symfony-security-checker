package com.fortify.ssc.parser.symfony.security_checker;
...
import com.fortify.ssc.parser.symfony.security_checker.parser.ScanParser;
import com.fortify.ssc.parser.symfony.security_checker.parser.VulnerabilitiesParser;

public class SymfonySecurityCheckerParserPlugin implements ParserPlugin<CustomVulnAttribute> {
    private static final Logger LOG = LoggerFactory.getLogger(SymfonySecurityCheckerParserPlugin.class);
